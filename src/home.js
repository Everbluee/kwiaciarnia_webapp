        ...
        <div className="container">
            ...
            <div className="box">
                ...
                <p>W tej zakładce znajdziesz informacje na temat naszych pracowników. Będziesz mieć możliwość zaktualizowania 
                    ...
                    bądź też usunięcie osoby z bazy danych i niepozostawienie po niej śladu.
                </p>
            </div>
        </div>
        <div className="container">
            <div className="box">
                <h2>Clients - Klienci</h2>
